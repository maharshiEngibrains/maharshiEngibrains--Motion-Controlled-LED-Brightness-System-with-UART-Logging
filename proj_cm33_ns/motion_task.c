 ...
 *              BMI270 Motion Sensor, detects the angle of orientation, adjusting 
 *              the LED brightness based on the angle using PWM and displays the
 *              sensor orientation.
 *
 *******************************************************************************/
...
/*Initializing the Queue instances*/
...
static cy_rslt_t motion_sensor_update_orientation(void)
{
    ...
    /* Read x, y, z component of acceleration */
    ...
    /* Computing the angle degree from the tilt angle */
    ...
    /* Sending the angle degree to the Queue */
    ...
    /* Z axis is most aligned with gravity.*/
    ...
    /* Y axis is most aligned with gravity.*/
    ...
    /* X axis is most aligned with gravity.*/
    else
    {
 ...
 *  and send the current orientation to the logging queue.
 *
 * Parameters:
...
static void LED_Control_Task(void *pvParameters){
    ...
    float angle;
        ...
        /* Initializing the PWM with the CYBSP_USER_LED1 */
    ...
    for(;;){
        ...
        /* Computing the duty cycle to map the angle degree with the PWM duty cycle percentage range */
        float duty = (angle/180.0) * 100.0;

        /* Setting the PWM duty cycle of intance pwm_led with the computed duty cycle and frequency */
        cyhal_pwm_set_duty_cycle(&pwm_led, duty, 1000);

        /* Sending the angle and duty cycle of perticular cycle for log */
 ...
 ********************************************************************************
 * Summary:
 *  Function that creates the motion sensor task,LED_Control_Task and the UARTLogTask.
 *
 * Parameters:
 *  None
 *
